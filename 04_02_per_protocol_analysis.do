*! docver: 2.0
*!  title: Analisis preliminar per protocol
*!   html: yes
*!    log: yes
*!comment: 
version 9.1
...
<h2> Análisis Final estudio GRAFD per protocolo  </h2>

<p> En este documento se presentan los mismos análisis que en el apartado de la población p0r intención de tratar pero restringido a los casos que cumplen por protocolo en la primera tabla se 
muestran los motivos por que no se han usado en la intención de tratar.
...
ht_summary motivo_salida_estudio , head close freq 




keep if per_protocol==1 
...
if `"`var'"'=="otras_causas_ucin" local tag="close"
 ...
 ht_rr `var' random , `tag'  wilson  wilson
 }
...
if `rd' !=.{
 ...
 local lirpp:disp  %5.2f lirpp[1]
  ...
  post  relrisk  ("`nomvar'") (`pa') (`pb') (`rd') (`lird') (`lsrd') (`rpp') (`lirpp') (`lsrpp') 
   ...
   save "$dta\result_pp.dta" ,replace
