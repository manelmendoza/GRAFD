*! docver: 2.0
*!  title: Analisis preliminar por  cir_v1_doppler==1
*!   html: yes
*!    log: yes
*!comment: 
version 9.1
...
<h2> Análisis Final estudio GRAFD  por cir_v1_doppler==1 </h2>

<p> En este documento se presentan los mismos análisis  para la población por itt con cir_v1_doppler==SI</p>
...
if `rd' !=.{
 ...
 local lirpp:disp  %5.2f lirpp[1]
  ...
  post  relrisk  ("`nomvar'") (`pa') (`pb') (`rd') (`lird') (`lsrd') (`rpp') (`lirpp') (`lsrpp') 
   ...
   save "$dta\result_dop1.dta" ,replace
